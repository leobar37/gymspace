...
export type Permission =
  ...
  | 'SUBSCRIPTION_REQUESTS_READ'
  | 'SUBSCRIPTION_REQUESTS_PROCESS'
  | 'SUBSCRIPTION_OPERATIONS_READ'
  | 'SUBSCRIPTION_OPERATIONS_CREATE'
  | 'SUBSCRIPTION_CANCELLATIONS_READ'
  | 'SUBSCRIPTION_CANCELLATIONS_PROCESS'
  | 'SUPER_ADMIN';
