...
import { type GetContractsParams } from '@gymspace/sdk';

interface ContractsSearchAndFiltersProps {
  searchTerm: string;
  onSearchTermChange: (term: string) => void;
  onSearch: (term: string) => void;
  filters: GetContractsParams;
  onFiltersChange: (filters: GetContractsParams) => void;
  activeFiltersCount: number;
}

export const ContractsSearchAndFilters: React.FC<ContractsSearchAndFiltersProps> = ({
  searchTerm,
  onSearchTermChange,
  onSearch,
  filters,
