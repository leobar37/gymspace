...
export const PERMISSIONS = {
  ...
  // Subscription Plans
  SUBSCRIPTION_PLANS_CREATE: 'SUBSCRIPTION_PLANS_CREATE',
  SUBSCRIPTION_PLANS_READ: 'SUBSCRIPTION_PLANS_READ',
  SUBSCRIPTION_PLANS_UPDATE: 'SUBSCRIPTION_PLANS_UPDATE',
  SUBSCRIPTION_PLANS_DELETE: 'SUBSCRIPTION_PLANS_DELETE',
  
  // Subscription Requests
  SUBSCRIPTION_REQUESTS_READ: 'SUBSCRIPTION_REQUESTS_READ',
  SUBSCRIPTION_REQUESTS_PROCESS: 'SUBSCRIPTION_REQUESTS_PROCESS',
  
  // Subscription Operations
  SUBSCRIPTION_OPERATIONS_READ: 'SUBSCRIPTION_OPERATIONS_READ',
  SUBSCRIPTION_OPERATIONS_CREATE: 'SUBSCRIPTION_OPERATIONS_CREATE',
  
  // Subscription Cancellations
  SUBSCRIPTION_CANCELLATIONS_READ: 'SUBSCRIPTION_CANCELLATIONS_READ',
  SUBSCRIPTION_CANCELLATIONS_PROCESS: 'SUBSCRIPTION_CANCELLATIONS_PROCESS',
