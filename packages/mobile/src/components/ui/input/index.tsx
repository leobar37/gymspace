...
const inputStyle = tva({
  base: 'border-background-200 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-200 items-center',
  variants: {
    size: {
      xl: 'h-14',
      lg: 'h-12',
...
const inputFieldStyle = tva({
  base: 'flex-1 text-typography-900 py-2 px-4 placeholder:text-typography-500 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
  parentVariants: {
    variant: {
