...
export class PaymentMethodsController {
  ...
  async createPaymentMethod(@Body() dto: CreatePaymentMethodDto, @AppCtxt() ctx: RequestContext) {
  ...
  async searchPaymentMethods(@Query() dto: SearchPaymentMethodDto, @AppCtxt() ctx: RequestContext) {
