...
const buttonStyle = tva({
  ...
  compoundVariants: [
    {
      variant: 'unstyled',
      class: 'bg-transparent data-[hover=true]:bg-transparent data-[active=true]:bg-transparent data-[active=true]:opacity-70 data-[focus-visible=true]:web:ring-0',
    },
    {
      action: 'primary',
      variant: 'link',
    ...
    return (
      <UIButton.Text
        ...
        className={buttonTextStyle({
          ...
          variant: variant as 'link' | 'outline' | 'solid' | 'unstyled' | undefined,
          size,
